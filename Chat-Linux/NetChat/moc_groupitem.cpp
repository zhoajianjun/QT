...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GroupItem_t, stringdata) + ofs \
...
const QMetaObject GroupItem::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GroupItem.data,
      qt_meta_data_GroupItem,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GroupItem.stringdata))
