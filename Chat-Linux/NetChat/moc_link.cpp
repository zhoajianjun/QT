...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Link_t, stringdata) + ofs \
...
const QMetaObject Link::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Link.data,
      qt_meta_data_Link,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Link.stringdata))
