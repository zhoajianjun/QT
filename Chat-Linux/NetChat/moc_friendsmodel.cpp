...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FriendsModel_t, stringdata) + ofs \
...
const QMetaObject FriendsModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_FriendsModel.data,
      qt_meta_data_FriendsModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FriendsModel.stringdata))
        return static_cast<void*>(const_cast< FriendsModel*>(this));
