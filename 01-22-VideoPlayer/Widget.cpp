...
//90,190,81        0,90,171
    ...
    stopButton->setStyleSheet("QPushButton{image:url(:/image/stop.png); border-radius:20px; background-color: rgb(40,40,40)}"
                                                "QPushButton::hover{background-color: rgb(90,90,90);  image:url(:/image/stopHovered.png);}");
   ...
   // QString name = QDir::currentPath();
    ...
    lastVideoButton->setStyleSheet("QPushButton{image:url(:/image/backward.png);border-radius:20px; background-color: rgb(40,40,40)}"
                                   "QPushButton:hover{background-color: rgb(90,90,90); image:url(:/image/backwardHovered.png)}");
    ...
    playButton->setStyleSheet("QPushButton{image:url(:/image/play.png);  border-radius:25px; background-color: rgb(40,40,40)}"
                                                "QPushButton::hover{background-color: rgb(90,90,90); image:url(:/image/playHovered.png)}");
    ...
    nextVideoButton->setStyleSheet("QPushButton{image:url(:/image/forward.png);border-radius:20px; background-color: rgb(40,40,40)}"
                                                         "QPushButton::hover{background-color: rgb(90,90,90);  image:url(:/image/forwardHovered.png)}");
    ...
    volumeButton->setStyleSheet("QPushButton{image:url(:/image/volume.png);border-radius:15px; background-color: rgb(40,40,40)}"
                                                         "QPushButton::hover{ image:url(:/image/volumeHovered.png);border-color:1px black; background-color:rgb(90,90,90);}");
...
void Widget::slotPlayModeListWidget()
{
    ...
    switch(row)
    {
        ...
        case 1:
        {
            ...
            playModeButton->setStyleSheet("QPushButton{border-radius:15px; image:url(:/image/itemLoop.png)}"
                                          "QPushButton:hover{background-color:rgb(90,90,90); }");
            break;
        }
        case 2:
        {
            ...
            playModeButton->setStyleSheet("QPushButton{border-radius:15px; image:url(:/image/sequential.png)}"
                                          "QPushButton:hover{background-color:rgb(90,90,90); }");
            break;
        }
        ...
        case 3:
        {
            ...
            playingMode = Loop;
            playModeButton->setStyleSheet("QPushButton{border-radius:15px; image:url(:/image/listLoop.png)}"
                                          "QPushButton:hover{background-color:rgb(90,90,90); }");
            break;
        }
        case 4:
        {
            ...
            playingMode = Random;
            playModeButton->setStyleSheet("QPushButton{border-radius:15px; image:url(:/image/random.png)}"
                                          "QPushButton:hover{background-color:rgb(90,90,90); }");
            break;
        }
        default:
    ...
    switch(state)
    {
        case QMediaPlayer::PlayingState:
        {
            ...
            playButton->setStyleSheet("QPushButton{image:url(pause.png);border-radius:25px; background-color: rgb(40,40,40)}"
                                                        "QPushButton::hover{background-color: rgb(90,90,90);image:url(:/image/pauseHovered.png)}");
            break;
        }
        default:
        {
...
void Widget::setThreeButton()
{
   ...
   // int a = this->rect().topRight().x();
    ...
    closeButton->setStyleSheet("QPushButton{image:url(:/image/close.png); border-radius:8px; background-color:rgb(60,65,68);}"
                                                  "QPushButton:hover{image:url(:/image/closeHovered.png);background-color:rgb(150,150,150);}");
    minimumButton->setStyleSheet("QPushButton{image:url(:/image/minimize.png); border-radius:8px; background-color:rgb(60,65,68);}"
                                                         "QPushButton:hover{image:url(:/image/minimizeHovered.png); background-color:rgb(120,120,120);}");
    maximumButton->setStyleSheet("QPushButton{image:url(:/image/maximize.png); border-radius:8px; background-color:rgb(60,65,68);}"
                                                        "QPushButton:hover{image:url(:/image/maximizeHovered.png); background-color:rgb(120,120,120);}");
