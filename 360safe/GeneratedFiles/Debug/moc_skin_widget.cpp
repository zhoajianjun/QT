...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SkinWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 53, 10)
    ...
    "showSkin\0page_count\0varyfySkin\0"
};
...
const QMetaObject SkinWidget::staticMetaObject = {
    { &DropShadowWidget::staticMetaObject, qt_meta_stringdata_SkinWidget.data,
      qt_meta_data_SkinWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SkinWidget.stringdata))
