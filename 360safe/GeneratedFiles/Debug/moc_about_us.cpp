...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AboutUsDialog_t, stringdata) + ofs \
...
const QMetaObject AboutUsDialog::staticMetaObject = {
    { &DropShadowWidget::staticMetaObject, qt_meta_stringdata_AboutUsDialog.data,
      qt_meta_data_AboutUsDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AboutUsDialog.stringdata))
