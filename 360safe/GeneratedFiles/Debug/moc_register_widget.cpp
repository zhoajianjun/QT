...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_RegisterWidget_t, stringdata) + ofs \
...
const QMetaObject RegisterWidget::staticMetaObject = {
    { &DropShadowWidget::staticMetaObject, qt_meta_stringdata_RegisterWidget.data,
      qt_meta_data_RegisterWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RegisterWidget.stringdata))
