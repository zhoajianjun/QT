...
FramelessHelperPrivate::FramelessHelperPrivate(QWidget *parent)
    : parent(parent),
      isMaximized(false),
      direction(None),
      buttonMaximized(0),
...
void FramelessHelperPrivate::addEdgeWidget(QWidget *widget)
{
...
void FramelessHelperPrivate::addDragWidget(QWidget *widget)
{
    if(!dragWidgets.contains(widget)) {
...
void FramelessHelperPrivate::checkPos()
{
...
void FramelessHelperPrivate::resize(const QPoint &cursorPos)
{
...
void FramelessHelperPrivate::refreshMaximizedButton()
{
...
bool FramelessHelperPrivate::eventFilter(QObject *obj, QEvent *event)
{
    do {
